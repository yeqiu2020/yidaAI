 ...
 *
 * 更新内容:
 * - v1.1.0: fetch 添加 30s 超时（AbortSignal.timeout），避免网络问题时无限等待
 *
...
const API_CLIENT_DIR = path.join(PROJECT_ROOT, '.agents', 'skills', 'api-client', 'scripts');

// ==================== 工具函数 ====================

/**
 * 查找项目根目录
 * Phase 6: 委托给 lib/core/utils.findProjectRoot（统一实现）
